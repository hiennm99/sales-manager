  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sticky top-4">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-xl font-bold text-gray-900">Tổng quan đơn hàng</h2>
      </div>
      ...
      <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-xl">
        <div className="flex items-start gap-2">
          ...
          <div className="text-xs text-yellow-800">
            ...
            <p>
              Tạm tính chỉ để hiển thị. Lợi nhuận = Thu nhập - Chi phí vận
              chuyển - Hoàn tiền - Chi phí khác.
            </p>
          </div>
        </div>
      </div>
