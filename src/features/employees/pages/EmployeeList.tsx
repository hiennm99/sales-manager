              ...
              {filteredEmployees.map((employee, index) => (
                ...
                >
                  <td className="px-6 py-4">
                      <span
                        className="inline-flex items-center gap-2 px-3 py-1 bg-purple-100 text-purple-700 text-sm font-semibold rounded-full">
                        {employee.code}
                      </span>
                  </td>
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4">
                      <span
                        className="inline-flex items-center gap-2 px-3 py-1 bg-indigo-100 text-indigo-700 text-xs font-bold rounded-full">
